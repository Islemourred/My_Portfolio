      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8">
          <div className="flex flex-col">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-white-100 text-xl font-bold tracking-tight">Islem's Portfolio</h2>
            </div>
            <div className="max-w-[300px] mt-6 p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200 shadow-soft">
              <p className="text-dark-gray italic text-sm leading-relaxed">
                ...
                <span className="block mt-2 text-secondary text-xs">- Steve Jobs</span>
              </p>
            </div>
          </div>

          <div className="flex flex-col">
            <h3 className="text-white-100 text-xl font-bold mb-6 tracking-tight">Contact me</h3>
          ...
          <div className="flex flex-col">
            <h3 className="text-white-100 text-xl font-bold mb-6 tracking-tight">Connect with me</h3>
            ...
            <div className="mt-auto">
              ...
              <div className="mt-6 p-4 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200 shadow-soft">
                <p className="text-dark-gray text-sm">Open to freelance opportunities and collaborations.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="mt-16 pt-8 border-t border-gray-200 text-center">
          <p className="text-secondary text-sm">
            © {currentYear} <span className="text-white-100 ml-1">Ourred Islem Charaf Eddine</span>
          </p>
        </div>
      </div>
    </footer>
